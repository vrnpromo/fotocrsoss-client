...
function getData_obf(method, data)
{
    ...
    // console.log({m: `|||uid||${data.uid}|||s_key||${data.s_key || -1}|||m||0||0||${method}|||m||0||1||${JSON.stringify(data.data) || {}}`});
    return {m: `|||uid||${data.uid}|||s_key||${data.s_key || -1}|||m||0||0||${method}|||m||0||1||${JSON.stringify(data.data) || {}}`};
...
export class DataLoader {
    ...
    // https://maganza.ru/fsnew/vk/htdocs/index.php - old
    // https://maganza.ru/fotocrossword/od/htdocs/index.php
    static get SERVER_API_URL() {return "https://maganza.ru/fotocrossword/od/htdocs/index.php"}

    static get SERVER_LEVELS_URL() {return "https://appcdn.ru/fotocrossword2/lvl"}
    // static get SERVER_LEVELS_URL() {return "https://maganza.ru/fotocrossword/od/htdocs/lvl"}		// old

    static get SERVER_IMGS_URL() {return "https://appcdn.ru/fotocrossword2/lvl_img"}

    static get api_id(){return "3226070"}
    static get secret_key() {return "zyn1WEQdzV92jTYqDevK"}

    static get key_data() {return "unique_key_for_GetSet_storage_data"}
